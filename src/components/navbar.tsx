...
function NavBar() {
    return (
        <nav className="">
            <ul className="flex flex-row md:flex-col md:mt-[30vh] md:w-[100px] justify-center items-center md:items-end md:justify-end place-self-start divide-solid text-sm">
                <li className="p-1">
